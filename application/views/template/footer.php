    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li><a href="<?= base_url('welcome/tentang') ?>">Tentang Kala Kini Nanti</a></li>
                        <li><a href="<?= base_url('welcome/kontak') ?>">Kontak Kala Kini Nanti</a></li>
                        <li><a href="http://sembilanmatahari.com/">Website Resmi Sembilan Matahari</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li><a href="#" data-toggle="modal" data-target="#exampleModalCenter">Untuk Pengunjung</a></li>
                        <li><a href="<?= base_url('welcome/guru') ?>">Untuk Staff</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2  col-md-6 col-sm-6">
        ...
        <div class="row footer-bottom d-flex justify-content-between align-items-center">
            <p class="col-lg-8 col-md-8 footer-text m-0">
                ...
                </script> All rights reserved | Sembilan Matahari
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
            <div class="col-lg-4 col-md-4 footer-social">
                <a href="https://www.facebook.com/SembilanMatahariNM"><i class="fa fa-facebook"></i></a>
                <a href="https://twitter.com/NMworld"><i class="fa fa-twitter"></i></a>
                <a href="https://www.instagram.com/sembilan_matahari/"><i class="fa fa-instagram"></i></a>
            </div>
        </div>
    </div>
</footer>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title text-dark font-weight-bold" style="color:#212529 !important;" id="exampleModalCenterTitle">
                    Kala Kini Nanti - Masuk Sekarang</h2>
